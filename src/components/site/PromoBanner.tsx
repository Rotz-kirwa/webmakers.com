  ...
  const styles =
    variant === "gold"
      ...
      : variant === "sky"
        ? {
            background:
              "linear-gradient(135deg, color-mix(in oklab, var(--royal) 12%, white), color-mix(in oklab, var(--gold) 8%, white))",
            color: "var(--navy)",
          }
  ...
  return (
    <section className="container-x py-10">
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute -left-20 -bottom-24 h-64 w-64 rounded-full opacity-25 blur-3xl"
          style={{ background: "var(--gold)" }}
        />
        <h3
          className="max-w-3xl text-2xl font-extrabold sm:text-3xl lg:text-4xl"
          style={{ color: "inherit" }}
        >
          {headline}
        </h3>
