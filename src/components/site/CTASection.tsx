  ...
  return (
    <section id="cta" className="container-x py-20">
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute -bottom-24 -right-10 h-80 w-80 rounded-full opacity-20 blur-3xl"
          style={{ background: "var(--royal)" }}
        />
        <h2
          className="relative mx-auto max-w-3xl text-3xl font-extrabold leading-tight text-white sm:text-5xl"
          style={{ color: "white" }}
        >
        ...
        <p className="relative mx-auto mt-4 max-w-2xl text-base text-white/85 sm:text-lg">
          Let WebMakers build a website that makes people trust your brand before they even call
          you.
        </p>
